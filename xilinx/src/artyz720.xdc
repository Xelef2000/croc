...
# Clock Source
# --------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN H16  IOSTANDARD LVCMOS33 }     [get_ports { sys_clk_p }];          #IO_L12P_T1_MRCC_35         Sch=sysclk
...
# Switches
# --------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN M20  IOSTANDARD LVCMOS33 }     [get_ports { fetch_en_i }];    #IO_L19N_T3_VREF_35         Sch=sw[0]
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 }     [get_ports { gpio_i[0]  }];    #IO_L24P_T3_34              Sch=sw[1]
...
set_property -dict { PACKAGE_PIN G17  IOSTANDARD LVCMOS33 }     [get_ports { gpio_o[3] }];       #IO_L16P_T2_35 Sch=LED4_G
